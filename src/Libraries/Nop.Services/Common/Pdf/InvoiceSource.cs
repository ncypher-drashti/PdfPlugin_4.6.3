...
namespace Nop.Services.Common.Pdf
{
    ...
    public partial class InvoiceSource : DocumentSource
    {
        ...
        /// Gets or sets the order number
        /// </summary>
        [DisplayName("Pdf.SalesQuotationNumberText")]
        public string SalesQuotationNumberText { get; set; }

        /// <summary>
        /// Gets or sets the order number
        /// </summary>
        [DisplayName("Pdf.SalesQuotationCustomerId")]
        public int SalesQuotationCustomerId { get; set; }

        ///// <summary>
        ///// Gets or sets the order number
        ///// </summary>
        //[DisplayName("PDFInvoice.PurchaseOrder")]
