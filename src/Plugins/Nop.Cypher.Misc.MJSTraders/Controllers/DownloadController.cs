...
namespace Nop.Cypher.Misc.MJSTraders.Controllers
{
    public partial class DownloadController : BasePublicController
    {
        ...
        public virtual async Task<IActionResult> PODocumentDownload(int downloadId)
        {
            ...
            //return result
            var fileName = !string.IsNullOrWhiteSpace(download.Filename) ? download.Filename : "PO Document";
